...
def get_file_name(directoryinput):
...
def write_file(personalinfo,path_file):
...
def print_information_from_file (information,path_file):
...
def main ():
    ...
    directoryinput = get_directory_name()
    path_file = get_file_name(directoryinput)
    personalinfo = get_user_information()
    write_file(personalinfo,path_file)
    information = open_file(path_file)
    print_information_from_file(information,path_file)
